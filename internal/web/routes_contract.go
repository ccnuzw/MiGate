...
func routeTable() []Route {
	...
	return []Route{
		...
		route(http.MethodGet, "/api/traffic/stream", AuthRequired, CSRFNotRequired, "trafficStreamHandler", func(d *routeDeps) http.HandlerFunc { return trafficStreamHandler(d.cfg.store, d.trafficCache) }),
