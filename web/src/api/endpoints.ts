...
export const api = {
  ...
  socks5Pool: (country = '') => get<Socks5PoolResponse>(`/api/outbounds/socks5-pool${country ? `?country=${encodeURIComponent(country)}` : ''}`),
  pingSocks5Pool: (proxy: Pick<Socks5PoolProxy, 'address' | 'port'>) => post<PingResult>('/api/outbounds/socks5-pool/ping', proxy),
  importSocks5Pool: (proxy: Socks5PoolProxy) => post('/api/outbounds/socks5-pool/import', proxy),
