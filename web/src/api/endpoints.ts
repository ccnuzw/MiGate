...
export const api = {
  ...
  xrayRestart: () => post<CoreActionResponse>('/api/xray/restart', { confirm: true, allow_system_changes: true }),
  xrayStop: () => post<CoreActionResponse>('/api/xray/stop', { confirm: true, allow_system_changes: true }),
  ...
  singboxRestart: () => post<CoreActionResponse>('/api/singbox/restart', { confirm: true, allow_system_changes: true }),
  singboxStop: () => post<CoreActionResponse>('/api/singbox/stop', { confirm: true, allow_system_changes: true }),
